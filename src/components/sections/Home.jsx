      ...
      <RevealOnScroll>
        <div className="text-center z-10 px-4">
          <h1 className="text-5xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-purple-500 to-pink-600 bg-clip-text text-transparent leading-right">
            Student in Computer Science & Cybersecurity
          </h1>

          <p className="md:text-2xl text-gray-400 text-lg mb-8 max-w-lg mx-auto">
            Passionate about tech, ethical hacking, and exploring the world.
          </p>
